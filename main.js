  ...
  Game.Init=function()
  {
    ...
    Game.shimmerTypes={
      ...
      'golden':{
        ...
        popFunc:function(me)
        {
          ...
          {
            buff=Game.gainBuff('long frenzy',Math.ceil(367*effectDurMod),2);
          }
          else if (choice=='supercharge')
          {
            buff=Game.gainBuff('supercharge',Math.ceil(17*effectDurMod),67);
          }
          ...
          else if (choice=='chain cookie')
          {
            ...
            var maxPayout=Math.min(Game.cookiesPs*60*60*4,Game.cookies*100)*mult;
            ...
            //break the chain if we're above 5 digits AND it's more than 100x of our bank, it grants more than 4 hours of our CpS, or just a 1% chance each digit (update : removed digit limit)
    ...
    Game.UpdateMenu=function()
    {
      ...
      else if (Game.onMenu=='stats')
      {
        ...
        '<div class="listing"><b>'+loc("Golden cookie clicks:")+'</b> '+Beautify(Game.goldenClicksLocal)+
        ' <small>('+loc("all time:")+' '+Beautify(Game.goldenClicks)+')</small> '+
    ...
    Game.modifyBuildingPrice=function(building,price)
    {
      ...
      if (Game.hasBuff('Crafty pixies')) price*=0.75;
      if (Game.hasBuff('Nasty goblins')) price*=1.50;
    ...
    Game.Upgrade.prototype.getPrice=function()
    {
      ...
      if (this.pool!='prestige')
      {
        ...
        if (Game.hasBuff('Haggler\'s luck')) price*=0.75;
        if (Game.hasBuff('Haggler\'s misery')) price*=1.50;
    ...
    */
    ...
    new Game.buffType('magic adept',function(time,pow)
    {
      return {
        name:'Magic adept',
        desc:loc("Spells do not backfire for %2.",[pow,Game.sayTime(time*Game.fps,-1)]),
        icon:[29,11],
        time:time*Game.fps,
        power:pow,
        max:true
    ...
    new Game.buffType('magic inept',function(time,pow)
    {
      return {
        name:'Magic inept',
        desc:loc("Spells always backfire for %2.",[pow,Game.sayTime(time*Game.fps,-1)]),
        icon:[29,11],
        time:time*Game.fps,
        power:pow,
        max:true
    ...
    Game.OpenSesame=function()
    {
      ...
      str+='<a class="option neato" '+Game.clickStr+'="Game.cookies*=1000000;Game.cookiesEarned*=1000000;">x1M</a>';
      str+='<a class="option neato" '+Game.clickStr+'="Game.cookies/=1000000;Game.cookiesEarned/=1000000;">/1M</a><br>';
      ...
      str+='<a class="option neato" '+Game.clickStr+'="Game.gainLumps(7777777);">+7777777 lumps</a>';
